...
public class MaterialIcon : Label
{
	...
	public string Name
	{
		...
		set
		{
			this.SetText( Char.ConvertFromUtf32( CodePoints[value] ) );
			_name = value;
		}
	}
	...
	public MaterialIcon()
	{
		StyleSheet.Load( "/ui/MaterialIcon.scss" );
		if ( this.Style.FontSize != null )
		{
			this.Style.Height = this.Style.FontSize;
			this.Style.Width = this.Style.FontSize;
		}
	}
	...
	public static MaterialIcon Create(Panel panel, string name="error")
	{
		var icon = panel.AddChild<MaterialIcon>();
		icon.Name = name;
		return icon;
	}

	public static readonly Dictionary<string, int> CodePoints = new()
	{
		{ "10k", 0xe951 },
		{ "10mp", 0xe952 },
		{ "11mp", 0xe953 },
